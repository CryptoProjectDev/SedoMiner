...
const std::string DonationAddress = "0x1C99004D6A1dE63e1Cf5C3Fba6a84544cBDc96Da";
...
{
	cout
	<< " Please consider a donation to SEDOminer development  (" << DonationAddress << ")" << endl
	<< " " << endl;
}
...
void help()
{
	cout
		<< endl
		<< " Usage: SEDOminer [OPTIONS]" << endl << endl
		<< " Options:" << endl << endl;
...
void version()
{
	cout
	<< " " << endl
	<< " SEDOminer (fork of MVis-tokenminer) " << dev::Version << endl
	<< " =====================================================================" << endl
	<< " " << endl;
	donations();
}
